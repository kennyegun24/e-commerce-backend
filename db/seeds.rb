...
category3 = Category.create(name: 'Home Appliances', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1680800798/appliances_cgqdol.jpg')
...
product2 = Product.create(name: 'Apple watch', size: '15inhs', color: 'red', price: '680', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/apple_watch_vtpir4-removebg-preview_ybdaoo.png', details:'Fairly used iphone', description: 'Beautiful camera and adequate performance', store: store1, category: category2, in_stock: 10)

product3 = Product.create(name: 'Samsung galaxy a40', size: '6.0inhs', color: 'Gold', price: '340', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414870/ssamsung_a20_jquvvr-removebg-preview_z1zrzq.png', details:'Is in perfect condition', description: 'Very new', store: store2, category: category2, in_stock: 10)

product4 = Product.create(name: 'Infinix hot 5pro', size: '7inhs', color: 'blue', price: '500', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414870/infinix_n5wgfp-removebg-preview_yuld1q.png', details:'Is in very good condition', description: 'Beautiful camera okay performance', store: store3, category: category2, in_stock: 10)
...
product6 = Product.create(name: 'Iphone 14pro max', size: '14inhs', color: 'blue', price: '720', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/iphone14_wkxepi-removebg-preview_gmyhdj.png', details:'Is in very good condition', description: 'Beautiful camera and performance', store: store1, category: category2, in_stock: 10)
...
product11 = Product.create(name: 'Nike air', size: '14inhs', color: 'Multi', price: '300', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1680878376/nike_kjhion.jpg', details:'Is in very good condition', description: 'Beautifully looking and comfortable', store: store2, category: category1, in_stock: 10)
...
product14 = Product.create(name: 'Electric heater', size: '14inhs', color: 'Black', price: '250', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1680878376/electric_heater_wilzoe.jpg', details:'Is in very good condition', description: 'Best performance', store: store3, category: category3, in_stock: 10)
...
product19 = Product.create(name: 'Television', size: '14inhs', color: 'Black', price: '250', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414870/tv_mnjxh9-removebg-preview_r8jwt4.png', details:'Is in very good condition', description: 'Best performance', store: store5, category: category3, in_stock: 10)
product20 = Product.create(name: 'New Balance', size: '14inhs', color: 'Brown', price: '250', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/new_baalance_wpsslq-removebg-preview_kmg19a.png', details:'Is in very good condition', description: 'Best performance', store: store5, category: category1, in_stock: 10)
product21 = Product.create(name: 'Jordan 4', size: '14inhs', color: 'Multi', price: '250', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/jordan4_b1r75p-removebg-preview_b3puir.png', details:'Is in very good condition', description: 'Best performance', store: store5, category: category1, in_stock: 10)
...
product23 = Product.create(name: 'Laptop', size: '14inhs', color: 'Silver', price: '250', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', details:'Is in very good condition', description: 'Best performance', store: store5, category: category2, in_stock: 10)

user = User.create(name: 'Kenny', password: '12345678', email: 'kennyegun@gmail.com')
Order.create(product_name: 'Laptop', user_name: 'Kenny', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 2, amount: 190, address: 'Yaba College of tech', tel_number: '0909009090', user: user, product: product23, store: store5, created_at: 'Mon, 12 Jan 2023 20:23:34.3109240000 UTC +00:00')
Order.create(product_name: 'Laptop', user_name: 'Kenny', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 2, amount: 600, address: 'Yaba College of tech', tel_number: '0909009090', user: user, product: product22, store: store5, created_at: 'Mon, 12 Jan 2023 20:23:34.3109240000 UTC +00:00')
...
Order.create(product_name: 'Laptop', user_name: 'Taiwo', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 5, amount: 120, address: 'University of Lagos', tel_number: '08023232323', user: user, product: product22, store: store5, created_at: 'Mon, 12 Mar 2023 20:23:34.3109240000 UTC +00:00')
Order.create(product_name: 'Laptop', user_name: 'Taiwo', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 6, amount: 400, address: 'Abesan of Lagos', tel_number: '08023232323', user: user, product: product19, store: store5, created_at: 'Mon, 12 Mar 2023 20:23:34.3109240000 UTC +00:00')
Order.create(product_name: 'Laptop', user_name: 'Taiwo', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 7, amount: 230, address: 'Abeokuta of Lagos', tel_number: '08023232323', user: user, product: product20, store: store5, created_at: 'Mon, 12 Jan 2023 20:23:34.3109240000 UTC +00:00')
Order.create(product_name: 'Laptop', user_name: 'Taiwo', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 3, amount: 100, address: 'University of Lagos', tel_number: '08023232323', user: user, product: product18, store: store5, created_at: 'Mon, 12 Apr 2023 20:23:34.3109240000 UTC +00:00')
Order.create(product_name: 'Laptop', user_name: 'Taiwo', image: 'https://res.cloudinary.com/drfqge33t/image/upload/v1682414871/laptop_ysdfav-removebg-preview_nwhxq3.png', quantity: 7, amount: 220, address: 'University of Lagos', tel_number: '08023232323', user: user, product: product17, store: store5, created_at: 'Mon, 12 Apr 2023 20:23:34.3109240000 UTC +00:00')